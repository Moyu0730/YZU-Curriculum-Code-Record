...
#include <deque>
#include "1131525 - deque - assignment.h"
...
void testAssignment1()
{
   ...
   for( size_t myOffA = 0; myOffA < dequeSize * mapSizeA; ++myOffA ){
      for( size_t mySizeA = 15; mySizeA <= dequeSize * mapSizeA - myOffA % dequeSize; ++mySizeA ){
         std::deque< T > deque1;
         ...
         *mySize2 = mySizeA;
         ...
         for( size_t myOffB = 2; myOffB < dequeSize * mapSizeB; ++myOffB ){
