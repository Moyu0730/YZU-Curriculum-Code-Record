...
public:
   ...
   iterator erase( const_iterator where )
   {
      ...
      //cout << "\n-----Start Erase-----\n";
      //cout << "\tMyOff  : " << myData.myOff << ", Off : " << static_cast<size_type>(where - begin()) << "\n";
      //cout << "\tMySize : " << myData.mySize << ", MapSize : " << myData.mapSize << "\n";
      //cout << "\tDequesize : " << dequeSize << "\n";
      //cout << "\tBefore Start\n";
      ...
      else
      {
         ...
         {
             //cout << "\tCloser to Front\n";
             for (size_t i = off + myData.myOff; i > myData.myOff; --i) {
                 ...
                 //cout << "\tChange Cnt(" << cntI << ", " << cntJ << ") to Nxt(" << nxtI << ", " << nxtJ << ")\n";

                 myData.map[cntI][cntJ] = myData.map[nxtI][nxtJ];
             }
         ...
         {
             //cout << "\tCloser to Back\n";
             for (size_t i = myData.myOff + off; i < myData.myOff + myData.mySize - 1; ++i) {
                 size_type cntI = i / dequeSize % myData.mapSize;
                 size_type cntJ = i % dequeSize;
                 size_type nxtI = (i + 1) % allSize / dequeSize % myData.mapSize;
                 size_type nxtJ = (i + 1) % dequeSize;
         ...
         //cout << "\tReturn MyOff : " << myData.myOff << ", Off : " << off << "\n";
