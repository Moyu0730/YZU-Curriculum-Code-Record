...
void testSet()
{
   ...
   {
      srand( seed );
      testSet1< T, greater< T >, std::greater< T > >();
   }
   cout << endl;
   ...
   {
      srand( seed );
      testSet2< T, greater< T >, std::greater< T > >();
   }
   cout << endl;
}
...
bool equal( set< T, T1 > &set1, std::set< T, T2 > &set2 )
{
   ...
   {
      color1 = static_cast< char >( *( head1 + 3 ) & 0x0000000FULL );
      color2 = static_cast< char >( *( head2 + 3 ) & 0x0000000FULL );
//      color1 = static_cast< char >( *( head1 + 3 ) % 256 );
//      color2 = static_cast< char >( *( head2 + 3 ) % 256 );

      isNil1 = static_cast< char >( *( head1 + 3 ) & 0x000000F0ULL );
      isNil2 = static_cast< char >( *( head2 + 3 ) & 0x000000F0ULL );
//      isNil1 = static_cast< char >( *( head1 + 3 ) / 256 % 256 );
//      isNil2 = static_cast< char >( *( head2 + 3 ) / 256 % 256 );
   }
   else // x86 platform
   {
      color1 = static_cast< char >( *( head1 + 3 ) & 0x000FUL );
      color2 = static_cast< char >( *( head2 + 3 ) & 0x000FUL );
//      color1 = static_cast< char >( *( head1 + 3 ) % 256 );
//      color2 = static_cast< char >( *( head2 + 3 ) % 256 );

      isNil1 = static_cast< char >( *( head1 + 3 ) & 0x00F0UL );
      isNil2 = static_cast< char >( *( head2 + 3 ) & 0x00F0UL );
//      isNil1 = static_cast< char >( *( head1 + 3 ) / 256 % 256 );
//      isNil2 = static_cast< char >( *( head2 + 3 ) / 256 % 256 );
   }
...
bool equal( size_t *node1, size_t *head1, size_t *node2, size_t *head2 )
{
   ...
   if( sizeof( size_t ) == 8 ) // x64 platform
   {
      color1 = static_cast< char >( *( node1 + 3 ) & 0x0000000FULL );
      color2 = static_cast< char >( *( node2 + 3 ) & 0x0000000FULL );
//      color1 = static_cast< char >( *( node1 + 3 ) % 256 );
//      color2 = static_cast< char >( *( node2 + 3 ) % 256 );

      isNil1 = static_cast< char >( *( node1 + 3 ) & 0x000000F0ULL );
      isNil2 = static_cast< char >( *( node2 + 3 ) & 0x000000F0ULL );
//      isNil1 = static_cast< char >( *( node1 + 3 ) / 256 % 256 );
//      isNil2 = static_cast< char >( *( node2 + 3 ) / 256 % 256 );

      switch( sizeof( Kty ) )
      {
      case 1:
         myVal1 = static_cast< Kty >( *( node1 + 3 ) & 0x00000F00ULL );
         myVal2 = static_cast< Kty >( *( node2 + 3 ) & 0x00000F00ULL );
//         myVal1 = static_cast< Kty >( *( node1 + 3 ) / 65536 % 256 );
//         myVal2 = static_cast< Kty >( *( node2 + 3 ) / 65536 % 256 );
         break;
      case 2:
         myVal1 = static_cast< Kty >( *( node1 + 3 ) & 0x0000FF00ULL );
         myVal2 = static_cast< Kty >( *( node2 + 3 ) & 0x0000FF00ULL );
//         myVal1 = static_cast< Kty >( *( node1 + 3 ) / 65536 % twoTo32 );
//         myVal2 = static_cast< Kty >( *( node2 + 3 ) / 65536 % twoTo32 );
         break;
      case 4:
         myVal1 = static_cast< Kty >( *( node1 + 3 ) & 0xFFFF0000ULL );
         myVal2 = static_cast< Kty >( *( node2 + 3 ) & 0xFFFF0000ULL );
...
//         myVal2 = static_cast< Kty >( *( node2 + 3 ) / twoTo32 );
   ...
   {
      color1 = static_cast< char >( *( node1 + 3 ) & 0x000FUL );
      color2 = static_cast< char >( *( node2 + 3 ) & 0x000FUL );
//      color1 = static_cast< char >( *( node1 + 3 ) % 256 );
//      color2 = static_cast< char >( *( node2 + 3 ) % 256 );

      isNil1 = static_cast< char >( *( node1 + 3 ) & 0x00F0UL );
      isNil2 = static_cast< char >( *( node2 + 3 ) & 0x00F0UL );
//      isNil1 = static_cast< char >( *( node1 + 3 ) / 256 % 256 );
//      isNil2 = static_cast< char >( *( node2 + 3 ) / 256 % 256 );
      ...
      {
      case 1:
         myVal1 = static_cast< Kty >( *( node1 + 3 ) & 0x0F00UL );
         myVal2 = static_cast< Kty >( *( node2 + 3 ) & 0x0F00UL );
//         myVal1 = static_cast< Kty >( *( node1 + 3 ) / 65536 % 256 );
//         myVal2 = static_cast< Kty >( *( node2 + 3 ) / 65536 % 256 );
         break;
      case 2:
         myVal1 = static_cast< Kty >( *( node1 + 3 ) & 0xFF00UL );
         myVal2 = static_cast< Kty >( *( node2 + 3 ) & 0xFF00UL );
